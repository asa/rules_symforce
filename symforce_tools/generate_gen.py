...
def symforce_sym(output_dir, geo_types, cam_types):
    ...
    # print("cam package")
    cam_package_codegen_stripped.generate(
        GEO_TYPES=GEO_TYPES, CAM_TYPES=CAM_TYPES, config=py_config, output_dir=py_base
    )
    # print_dir(py_base)
